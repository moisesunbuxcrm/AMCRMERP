        ...
        if ($num || $forceshowtitle)
        {
        	...
        	if (count($listofactions))
        	{
	        	...
	        	foreach($listofactions as $action)
	        	{
                    ...
                    // pdermody start
                    if ($action->fulldayevent == 1) // pdermody
                    {
                        print '<td align="center">'.dol_print_date($action->datep, 'day');
                        print ' - All Day';
                        print '</td>';
                    }
                    else
                    ...
                    // pdermody end
                        ...
                        print '<td align="center">'.dol_print_date($action->datep, 'dayhour');//pdermody, 'tzuserrel');
                        if ($action->datef)
                        {
                            ...
                            {
                                if ($tmpa['hours'] != $tmpb['hours'] || $tmpa['minutes'] != $tmpb['minutes'] && $tmpa['seconds'] != $tmpb['seconds']) print '-'.dol_print_date($action->datef, 'hour');//pdermody, 'tzuserrel');
                            }
                            else print '-'.dol_print_date($action->datef, 'dayhour');//pdermody, 'tzuserrel');
                        }
                        print '</td>';
