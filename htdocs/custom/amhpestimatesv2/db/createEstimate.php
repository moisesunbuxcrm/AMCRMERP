...
$eDB->deposit_percent = GETPOST("deposit_percent", 'alpha');
$eDB->deposit_percent_with_install = GETPOST("deposit_percent_with_install", 'alpha');
$eDB->percent_final_inspection = GETPOST("percent_final_inspection", 'alpha');
$eDB->warranty_years = GETPOST("warranty_years", 'alpha');
