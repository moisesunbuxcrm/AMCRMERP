...
/**
 *	\file       htdocs/amhppermits/template/amhppermitsindex.php
 *	\ingroup    amhppermits
 *	\brief      Home page of amhppermits top menu
 */
...
$langs->loadLangs(array("amhppermits@amhppermits"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->amhppermits->read) accessforbidden();
...
llxHeader("",$langs->trans("AMHPPermitsArea"));

print load_fiche_titre($langs->trans("AMHPPermitsArea"),'','amhppermits.png@amhppermits');
...
// Draft MyObject
if (! empty($conf->amhppermits->enabled) && $user->rights->amhppermits->read)
{
	$langs->load("orders");
