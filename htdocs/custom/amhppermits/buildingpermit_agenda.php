...
/**
 *  \file       buildingpermit_agenda.php
 *  \ingroup    amhppermits
 *  \brief      Page of BuildingPermit events
 */
...
$hookmanager->initHooks(array('buildingpermitagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("BuildingPermit"), -1, 'buildingpermit@amhppermits');
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		print load_fiche_titre($langs->trans("ActionsOnBuildingPermit"),'','');
