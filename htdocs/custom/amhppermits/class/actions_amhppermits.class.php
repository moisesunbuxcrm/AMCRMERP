...
/**
 * \file    amhppermits/class/actions_amhppermits.class.php
 * \ingroup amhppermits
...
class ActionsAMHPPermits
{
	...
	public function addMoreMassActions($parameters, &$object, &$action, $hookmanager)
	{
	    ...
	    if (in_array($parameters['currentcontext'], array('somecontext1','somecontext2')))		// do something only for the context 'somecontext1' or 'somecontext2'
	    {
	        $this->resprints = '<option value="0"'.($disabled?' disabled="disabled"':'').'>'.$langs->trans("AMHPPermitsMassAction").'</option>';
	    }
	...
	function includeThirdPartyCustomizations($parameters, &$object, &$action, $hookmanager)
	{
		...
		{
			include(__DIR__."/../thirdparty/Unit_Loc.js.php");
		}
