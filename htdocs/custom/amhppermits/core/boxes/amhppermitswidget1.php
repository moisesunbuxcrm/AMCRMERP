...
/**
 * \file    modulebuilder/template/core/boxes/amhppermitswidget1.php
 * \ingroup amhppermits
 * \brief   Widget provided by AMHPPermits
 *
 ...
 */
class amhppermitswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "amhppermitsbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "amhppermits@amhppermits";
	 ...
	 */
	public $depends = array('amhppermits');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->amhppermits->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/amhppermits/class/amhppermits.class.php";

		// Populate the head at runtime
		$text = $langs->trans("AMHPPermitsBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_amhppermits@amhppermits',
