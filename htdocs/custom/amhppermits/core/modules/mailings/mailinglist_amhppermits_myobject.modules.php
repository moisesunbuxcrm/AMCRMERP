...
dol_include_once("/amhppermits/class/myobject.class.php");


/**
 * mailing_mailinglist_amhppermits
 */
class mailing_mailinglist_amhppermits_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_amhppermits_myobject';
	...
	var $picto='amhppermits@amhppermits';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('amhppermits',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/amhppermits/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_amhppermits_myobject.modules.php: mailing ".$num." targets found");
