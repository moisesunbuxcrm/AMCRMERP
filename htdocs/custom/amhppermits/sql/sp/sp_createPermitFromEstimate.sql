DROP PROCEDURE IF EXISTS `createPermitFromEstimate`;
--
CREATE PROCEDURE `createPermitFromEstimate`(IN `tpId` INT, IN `eId` INT)
    MODIFIES SQL DATA

	INSERT INTO `llx_amhppermits_buildingpermit` (
        `ref`, `entity`, `label`, `fk_soc`, `EID`,
        `date_creation`, `tms`,
