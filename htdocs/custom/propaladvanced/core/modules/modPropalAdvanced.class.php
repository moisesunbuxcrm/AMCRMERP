...
/**
 * 	\defgroup   propaladvanced     Module PropalAdvanced
 *  \brief      PropalAdvanced module descriptor.
 *
 *  \file       htdocs/propaladvanced/core/modules/modPropalAdvanced.class.php
 *  \ingroup    propaladvanced
 *  \brief      Description and activation file for module PropalAdvanced
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';
include_once DOL_DOCUMENT_ROOT.'/custom/propaladvanced/class/getData.php';

/**
 *  Description and activation class for module PropalAdvanced
 */
class modPropalAdvanced extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'propaladvanced';
		...
		// Module label (no space allowed), used if translation string 'ModulePropalAdvancedName' not found (PropalAdvanced is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModulePropalAdvancedDesc' not found (PropalAdvanced is name of module).
		$this->description = "PropalAdvancedDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "PropalAdvancedDescription";

		// Author
		$this->editor_name = 'unboxerp';
		$this->editor_url = 'www.unboxerp.com';
		...
		// Key used in llx_const table to save module status enabled/disabled (where PROPALADVANCED is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/propaladvanced/css/propaladvanced.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/propaladvanced/js/propaladvanced.js.php',
			),
		...
		// Example: this->dirs = array("/propaladvanced/temp","/propaladvanced/subdir");
		$this->dirs = array("/propaladvanced/temp");

		// Config pages. Put here list of php page, stored into propaladvanced/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@propaladvanced");
		...
		$this->langfiles = array("propaladvanced@propaladvanced");
		...
		//$this->automatic_activation = array('FR'=>'PropalAdvancedWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('PROPALADVANCED_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('PROPALADVANCED_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->propaladvanced) || !isset($conf->propaladvanced->enabled)) {
			$conf->propaladvanced = new stdClass();
			$conf->propaladvanced->enabled = 0;
		}

		// Array to add new pages in new tabs
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@propaladvanced:$user->rights->propaladvanced->read:/propaladvanced/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@propaladvanced:$user->rights->othermodule->read:/propaladvanced/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		/* Example:
		$this->dictionaries=array(
			'langs'=>'propaladvanced@propaladvanced',
			...
			'tabcond'=>array(isModEnabled('propaladvanced'), isModEnabled('propaladvanced'), isModEnabled('propaladvanced')),
		...
		*/
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in propaladvanced/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'propaladvancedwidget1.php@propaladvanced',
			//      'note' => 'Widget provided by PropalAdvanced',
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/propaladvanced/class/myobject.class.php',
			//      'objectname' => 'MyObject',
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => 'isModEnabled("propaladvanced")',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'isModEnabled("propaladvanced")', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("propaladvanced")', 'priority'=>50)
		// );
		...
		$this->rights[$r][1] = 'Read objects of PropalAdvanced'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'read'; // In php code, permission will be checked by test if ($user->hasRight('propaladvanced', 'myobject', 'read'))
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update objects of PropalAdvanced'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->hasRight('propaladvanced', 'myobject', 'write'))
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Delete objects of PropalAdvanced'; // Permission label
		$this->rights[$r][4] = 'myobject';

		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->propaladvanced->myobject->delete)
		$r++;*/
		...
		$this->menu[$r++] = array(
			...
			'titre'=>'ModulePropalAdvancedName',
			'prefix' => img_picto('', $this->picto, 'class="paddingright pictofixedwidth valignmiddle"'),
			'mainmenu'=>'propaladvanced',
			'leftmenu'=>'',
			'url'=>'/propaladvanced/propaladvancedindex.php',
			'langs'=>'propaladvanced@propaladvanced', // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000 + $r,
			'enabled'=>'isModEnabled("propaladvanced")', // Define condition to show or hide menu entry. Use 'isModEnabled("propaladvanced")' if entry must be visible if module is enabled.
			'perms'=>'1', // Use 'perms'=>'$user->hasRight("propaladvanced", "myobject", "read")' if you want your menu with a permission rules
			'target'=>'',
		...
		/*$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=propaladvanced',      // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			...
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("propaladvanced")', // Define condition to show or hide menu entry. Use 'isModEnabled("propaladvanced")' if entry must be visible if module is enabled.
			'perms'=>'$user->hasRight("propaladvanced", "myobject", "read")',
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=propaladvanced,fk_leftmenu=myobject',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>'List_MyObject',
			'mainmenu'=>'propaladvanced',
			'leftmenu'=>'propaladvanced_myobject_list',
			'url'=>'/propaladvanced/myobject_list.php',
			'langs'=>'propaladvanced@propaladvanced',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("propaladvanced")', // Define condition to show or hide menu entry. Use 'isModEnabled("propaladvanced")' if entry must be visible if module is enabled.
			'perms'=>'$user->hasRight("propaladvanced", "myobject", "read")'
		...
		$this->menu[$r++]=array(
			...
			'titre'=>'New_MyObject',
			'mainmenu'=>'propaladvanced',
			'leftmenu'=>'propaladvanced_myobject_new',
			'url'=>'/propaladvanced/myobject_card.php?action=create',
			'langs'=>'propaladvanced@propaladvanced',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("propaladvanced")', // Define condition to show or hide menu entry. Use 'isModEnabled("propaladvanced")' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=>'$user->hasRight("propaladvanced", "myobject", "write")'
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);*/
		...
		$this->export_icon[$r]='myobject@propaladvanced';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'MyObject'; $keyforclassfile='/propaladvanced/class/myobject.class.php'; $keyforelement='myobject@propaladvanced';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'MyObjectLine'; $keyforclassfile='/propaladvanced/class/myobject.class.php'; $keyforelement='myobjectline@propaladvanced'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='myobject'; $keyforaliasextra='extra'; $keyforelement='myobject@propaladvanced';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='myobjectline'; $keyforaliasextra='extraline'; $keyforelement='myobjectline@propaladvanced';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		...
		$this->import_icon[$r]='myobject@propaladvanced';
		$this->import_tables_array[$r] = array('t' => MAIN_DB_PREFIX.'propaladvanced_myobject', 'extra' => MAIN_DB_PREFIX.'propaladvanced_myobject_extrafields');
		...
		$this->import_fieldshidden_array[$r] = array('extra.fk_object' => 'lastrowid-'.MAIN_DB_PREFIX.'propaladvanced_myobject');
		...
		$this->import_convertvalue_array[$r] = array(
			't.ref' => array(
				'rule'=>'getrefifauto',
				'class'=>(!getDolGlobalString('PROPALADVANCED_MYOBJECT_ADDON') ? 'mod_myobject_standard' : getDolGlobalString('PROPALADVANCED_MYOBJECT_ADDON')),
				'path'=>"/core/modules/commande/".(!getDolGlobalString('PROPALADVANCED_MYOBJECT_ADDON') ? 'mod_myobject_standard' : getDolGlobalString('PROPALADVANCED_MYOBJECT_ADDON')).'.php'
				'classobject'=>'MyObject',
				'pathobject'=>'/propaladvanced/class/myobject.class.php',
			),
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'propaladvanced');
		$result = $this->_load_tables('/propaladvanced/sql/');
		if ($result < 0) {
		...
		//$result1=$extrafields->addExtraField('propaladvanced_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'propaladvanced@propaladvanced', 'isModEnabled("propaladvanced")');
		//$result2=$extrafields->addExtraField('propaladvanced_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'propaladvanced@propaladvanced', 'isModEnabled("propaladvanced")');
		//$result3=$extrafields->addExtraField('propaladvanced_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'propaladvanced@propaladvanced', 'isModEnabled("propaladvanced")');
		//$result5=$extrafields->addExtraField('propaladvanced_myattr4', "New Attr 4 label", 'select',  1,  3, 'propal',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'propaladvanced@propaladvanced', 'isModEnabled("propaladvanced")');
		//$result5=$extrafields->addExtraField('propaladvanced_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'propaladvanced@propaladvanced', 'isModEnabled("propaladvanced")');
		...
		$product_type = getProductsTypes();
		$material_type = getMaterialsTypes();
		$windows_type = getWindowsTypes();
		$items_type = getItemsTypes();
		$mount = getMount();
		$anugular_type = getAngularType();
		$lock = getLock();
		...
		// Document templates
		$moduledir = dol_sanitizeFileName('propaladvanced');
		$myTmpObjects = array();
