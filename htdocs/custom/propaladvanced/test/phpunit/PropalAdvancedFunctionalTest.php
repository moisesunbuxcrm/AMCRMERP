...
/**
 * \file    test/phpunit/PropalAdvancedFunctionalTest.php
...
/**
 * Class PropalAdvancedFunctionalTest
 *
 ...
 *
 * @package Testpropaladvanced
 */
class PropalAdvancedFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500500; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPropalAdvanced')->click();
		} else {
			// Disable the module
			$this->byHref('modPropalAdvanced')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/propaladvanced/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('propaladvanced/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/propaladvanced/admin/about.php');
		$this->authenticate();
		return $this->assertContains('propaladvanced/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('propaladvancedwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPropalAdvanced_PropalAdvancedTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPropalAdvanced_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
